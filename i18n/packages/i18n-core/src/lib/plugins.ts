/**
 * file: plugins.ts
 * description: 插件管理器 — 可扩展的 i18n 插件生命周期管理
 * author: YanYuCloudCube Team <admin@0379.email>
 * version: v2.0.0
 * created: 2026-03-21
 * updated: 2026-06-09
 * status: active
 * tags: [core],[i18n],[plugin],[extension]
 *
 * brief: 管理 I18nPlugin 的注册、初始化、销毁与生命周期回调
 *
 * details:
 * - PluginManager 支持多插件注册与批量管理
 * - I18nPlugin 接口定义 init/destroy 生命周期钩子
 * - I18nContext 提供插件可访问的翻译和语言信息
 * - 插件异常隔离：单个插件异常不影响其他插件和主流程
 * - 支持 onTranslate 拦截器风格的翻译后处理
 *
 * dependencies: types.js
 * exports: PluginManager, I18nPlugin, I18nContext
 * notes: 插件按注册顺序执行，init 和 destroy 逆向调用
 */
