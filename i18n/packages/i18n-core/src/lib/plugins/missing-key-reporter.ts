 ...
 * description: 缺失 Key 报告插件 — 翻译覆盖率质量监控
 * author: YanYuCloudCube Team <admin@0379.email>
 * version: v2.0.0
 * created: 2026-03-21
 * updated: 2026-06-09
 * status: active
 * tags: [plugin],[i18n],[quality],[monitoring]
 *
 * brief: 跟踪未翻译的 key 并生成覆盖率报告
 *
 * details:
 * - 实现 I18nPlugin 接口（init/destroy 生命周期）
 * - onTranslate 钩子检测 key 回落至英文原文的情况
 * - 维护缺失 key 的 Set 集合，去除重复
 * - getReport() 输出包含缺失 key 列表和覆盖率百分比
 * - 支持 locale 级别的独立追踪
 *
 * dependencies: plugins.js
 * exports: MissingKeyReporterPlugin
 * notes: 适合集成到 CI/CD 质量门禁
 */
